...
#define LED_PIN_OD_1	{LED_1=1; PBMOD32= PBMOD32 & 0x0F | PIN_H_Mode_OD;}
#define LED_PIN_OD_2	{LED_2=1; PDMOD10= PDMOD10 & 0xF0 | PIN_L_Mode_OD;}
#define LED_PIN_OD_3	{LED_3=1; PDMOD10= PDMOD10 & 0x0F | PIN_H_Mode_OD;}
...
#define LED_PIN_PP_1(type)	{PBMOD32= PBMOD32 & 0x0F | PIN_H_Mode_PP; if(type)LED_1=1;else LED_1=0;}
